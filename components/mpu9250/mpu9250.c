...
gpio_num_t I2C_MASTER_SCL_IO = GPIO_NUM_22; //default value for I2C master clock
gpio_num_t I2C_MASTER_SDA_IO = GPIO_NUM_21; //default value for I2C master data
...
void choose_SCL_SDA_GPIO(gpio_num_t SCL,gpio_num_t SDA){
  I2C_MASTER_SCL_IO = SCL;
  I2C_MASTER_SDA_IO = SDA;
}
